...
interface BitcoinButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  children: React.ReactNode;
  showArrow?: boolean;
}

const BitcoinButton: React.FC<BitcoinButtonProps> = ({ children, className, showArrow = false, ...props }) => {
  const BitcoinIcon = () => (
  ...
  return (
    <button className={cn("bitcoin-button", className)} {...props}>
      ...
      {/* Explosion Stars */}
      <div className="btn-star star-1"><BitcoinIcon /></div>
      <div className="btn-star star-2"><BitcoinIcon /></div>
      <div className="btn-star star-3"><BitcoinIcon /></div>
      <div className="btn-star star-4"><BitcoinIcon /></div>
      <div className="btn-star star-5"><BitcoinIcon /></div>
      <div className="btn-star star-6"><BitcoinIcon /></div>
    </button>
  );
};
