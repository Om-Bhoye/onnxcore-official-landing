                    ...
                    <div id="cyber-card">
                      <div className="cyber-card-content">
                        ...
                        <div className="relative z-10 flex flex-col items-center justify-center text-center h-full p-8 lg:p-10 pointer-events-auto">
                          <div className="text-violet font-mono text-xs lg:text-sm font-bold mb-4 tracking-[0.2em] transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                            STEP {step.number}
                          </div>
                          ...
                          <h3 className="font-heading font-bold text-2xl text-white mb-4 bg-gradient-to-r from-blue-400 to-orange-400 bg-clip-text text-transparent">
                            {step.title}
                          </h3>

                          <p className="text-cobalt-200 text-sm lg:text-base leading-relaxed">
                            {step.description}
                          </p>
                        </div>
                      </div>
